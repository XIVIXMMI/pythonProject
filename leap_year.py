...
#    _  The year can be evenly divided by 4, is a leap year, unless:
#    _  The year can be evenly divided by 100, it is NOT a leap year, unless:
#    _  The year is also evenly divisible by 400. Then it is
